  ...
  return (
    ...
    >
      ...
      <p className="mt-7 font-Raleway tracking-[0.975px] max-w-[593px] leading-5 text-[15px] text-center">
        ...
        and user-friendly web experiences. Eager to leverage my educational
        background in [Your Degree or Relevant Courses] and enthusiasm for
        front-end technologies to contribute and grow as a valuable member of a
